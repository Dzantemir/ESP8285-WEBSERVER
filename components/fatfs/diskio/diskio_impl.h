...
#include "ff.h"        /* Needed for LBA_t type definition */
#include "diskio.h"
#include "esp_err.h"
...
typedef struct {
    ...
    DRESULT (*read) (unsigned char pdrv, unsigned char* buff, LBA_t sector, unsigned count);  /*!< sector read function */
    DRESULT (*write) (unsigned char pdrv, const unsigned char* buff, LBA_t sector, unsigned count);   /*!< sector write function */
